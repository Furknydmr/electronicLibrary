...
class OkurDuyuruAdapter (private val duyuruList: List<OrtakDuyuruEkleList>):
    RecyclerView.Adapter<OkurDuyuruAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.okur_duyuru_item,parent,false)
